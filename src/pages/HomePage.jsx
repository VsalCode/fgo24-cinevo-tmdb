...
const HomePage = () => {
  return (
    <main>
      ...
      <section className="flex flex-col items-center text-center mt-30 lg:px-15 sm:px-10 px-6">
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="lg:text-6xl md:text-5xl text-4xl">
            ...
            <p className="text-primary font-extrabold">Book Your Tickets Today</p>
          </div>
          <div>
      ...
      <section id="benefit-page" className="bg-secondary w-full text-sixth flex lg:flex-row flex-col lg:px-15 px-10 h-fit py-20 rounded-6xl justify-center items-center ">
        ...
        <div className="flex lg:flex-row md:gap-5 flex-col gap-10 items-center">
